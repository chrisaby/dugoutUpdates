...
export default async function BracketPage() {
  ...
  if (settingsError) console.error('[bracket] tournament_settings query failed:', settingsError.message)
  if (knockoutError) console.error('[bracket] matches query failed:', knockoutError.message)
